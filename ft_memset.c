...
Return Type (void *): The function returns a pointer to the memory block that was set.
Parameters:
void *b: A pointer to the memory block to be set.
int c: The value to set each byte of the memory block to. This value is converted to an unsigned char.
